...
if __name__ == '__main__':
    ...
    # Carregar o dataset
    df_result = pd.read_csv('biobertpt/lung_rads_data/lung_rads_test_predicted.csv')
    ...
    df_results_post_processed.to_csv('biobertpt/lung_rads_data/lung_rads_test_predicted_post_processed.csv', encoding='utf-8', index=False)
